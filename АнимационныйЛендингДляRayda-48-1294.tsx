...
import svgPaths from "./svg-n1ikgv1s0n";
...
type Icon30VectorBackgroundImageProps = {
  additionalClassNames?: string;
};

function Icon30VectorBackgroundImage({ additionalClassNames = "" }: Icon30VectorBackgroundImageProps) {
  return (
  ...
  return (
    <div className="absolute left-[12px] size-[24px] top-[16px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p27c543b0} id="Vector" stroke="url(#paint0_linear_48_1338)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p2d59bff0} id="Vector_2" stroke="url(#paint1_linear_48_1338)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_48_1338" x1="4" x2="20" y1="11.9999" y2="11.9999">
            <stop stopColor="#155DFC" />
            <stop offset="1" stopColor="#1447E6" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_48_1338" x1="9" x2="15" y1="10" y2="10">
            <stop stopColor="#155DFC" />
            <stop offset="1" stopColor="#1447E6" />
          </linearGradient>
        </defs>
    ...
    <div className="bg-white relative size-full" data-name="Анимационный лендинг для RAYDA">
      <div className="absolute content-stretch flex flex-col h-[4794.833px] items-start left-0 pt-[64px] top-0 w-[365.333px]" data-name="Layout">
        <div className="h-[4156px] relative shrink-0 w-[365.333px]" data-name="Rental" style={{ backgroundImage: "linear-gradient(95.0237deg, rgb(249, 250, 251) 0%, rgb(243, 244, 246) 100%)" }}>
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <div className="absolute content-stretch flex flex-col h-[208px] items-start left-0 pt-[48px] top-0 w-[365.333px]" data-name="Section" style={{ backgroundImage: "linear-gradient(111.432deg, rgba(21, 93, 252, 0.2) 9.1334%, rgba(126, 59, 232, 0.4) 65.343%, rgba(255, 16, 207, 0.6) 113.06%)" }}>
              <div className="h-[112px] relative shrink-0 w-full" data-name="Container">
                <div className="flex flex-col items-center justify-center size-full">
                  <div className="content-stretch flex flex-col gap-[8px] items-center justify-center px-[16px] relative size-full text-[#1e2939] text-center">
                    <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[40px] relative shrink-0 text-[36px] whitespace-nowrap">Прокат</p>
                    <div className="font-['Montserrat:Regular',sans-serif] font-normal leading-[28px] relative shrink-0 text-[21px] w-[306px] whitespace-pre-wrap">
                      <p className="mb-0">{`велосипедов `}</p>
                      <p>по лучшим ценам</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="absolute content-stretch flex flex-col gap-[32px] h-[876px] items-start left-0 px-[16px] top-[256px] w-[365.333px]" data-name="Section">
              <div className="h-[36px] relative shrink-0 w-full" data-name="Heading 2">
                <p className="-translate-x-1/2 absolute font-['Montserrat:Bold',sans-serif] font-bold leading-[36px] left-[166.79px] text-[#155dfc] text-[30px] text-center top-[-1.33px] whitespace-nowrap">Условия проката</p>
              </div>
            ...
            <div className="absolute bg-white content-stretch flex flex-col gap-[32px] h-[592px] items-start left-0 pt-[48px] px-[16px] top-[1180px] w-[365.333px]" data-name="Section">
              ...
              <div className="content-stretch flex flex-col h-[428px] items-start pt-[24px] px-[24px] relative rounded-[16px] shadow-[0px_20px_25px_0px_rgba(0,0,0,0.1),0px_8px_10px_0px_rgba(0,0,0,0.1)] shrink-0" data-name="Form" style={{ backgroundImage: "linear-gradient(127.912deg, rgb(249, 250, 251) 0%, rgb(243, 244, 246) 100%)" }}>
                <div className="content-stretch flex flex-col gap-[24px] h-[380px] items-start relative shrink-0 w-[285.333px]" data-name="Rental">
                  ...
                  <div className="absolute h-[84px] left-[24px] top-[144px] w-[285.333px]" data-name="Rental">
                    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-center justify-center left-[calc(50%-0.44px)] top-0">
                      ...
                      <div className="h-[28px] relative rounded-[44739200px] shrink-0 w-[100px]" data-name="Paragraph" style={{ backgroundImage: "linear-gradient(99.2788deg, rgb(0, 85, 255) 2.1872%, rgb(155, 90, 255) 53.969%, rgb(212, 79, 223) 104.76%)" }}>
                        <p className="-translate-x-1/2 absolute font-['Montserrat:Regular',sans-serif] font-normal leading-[20px] left-[calc(50%+0.27px)] text-[14px] text-center text-white top-[calc(50%-11px)] whitespace-nowrap">Сложный</p>
                      </div>
                    </div>
                  </div>
                </ContainerBackgroundImage>
        ...
        <div className="content-stretch flex h-[64px] items-center justify-between relative shrink-0 w-full" data-name="Container">
          <div className="h-[40px] relative shrink-0 w-[121.917px]" data-name="Link">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4.214px] items-center pl-[-3.786px] relative size-full">
              <BackgroundImage3 additionalClassNames="size-[47.571px]">
                <div className="flex-none rotate-[-167.76deg]">
                  <div className="bg-[#155dfc] relative rounded-[44739200px] size-[40px]" data-name="Container">
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[14.343px] relative size-full">
                      <BackgroundImage3 additionalClassNames="h-[30.544px] w-[20.595px]">
                        <div className="flex-none rotate-[167.76deg]">
          ...
          <div className="relative shrink-0 size-[40px]" data-name="Button">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[8px] px-[8px] relative size-full">
              <div className="h-[24px] overflow-clip relative shrink-0 w-full" data-name="Icon">
                <Icon30VectorBackgroundImage additionalClassNames="bottom-1/2 top-1/2" />
                <Icon30VectorBackgroundImage additionalClassNames="bottom-3/4 top-1/4" />
                <Icon30VectorBackgroundImage additionalClassNames="bottom-1/4 top-3/4" />
              </div>
            </div>
          </div>
        </div>
