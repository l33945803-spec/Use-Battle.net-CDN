...
import svgPaths from "./svg-82l3pt5wf8";
...
function BackgroundImage1({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage1Props>) {
  return (
    <div style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties} className={clsx("flex items-center justify-center relative shrink-0", additionalClassNames)}>
      {children}
    </div>
  );
}
            ...
            <div className="h-[1340px] relative shrink-0 w-full" data-name="Section">
              <div className="content-stretch flex flex-col gap-[32px] items-start px-[16px] relative size-full">
                <div className="h-[36px] relative shrink-0 w-full" data-name="Heading 2">
                  <p className="-translate-x-1/2 absolute bg-clip-text bg-gradient-to-r font-['Montserrat:Bold',sans-serif] font-bold from-[#155dfc] leading-[36px] left-[166.75px] text-[30px] text-[transparent] text-center to-[#1447e6] top-[-1.33px] whitespace-nowrap">Наши модели</p>
                </div>
                <div className="h-[1272px] relative shrink-0 w-full" data-name="Container">
                  <div className="absolute bg-white content-stretch flex flex-col h-[300px] items-start left-0 overflow-clip rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-0 w-[333.333px]" data-name="Container">
                    <div className="h-[192px] overflow-clip relative shrink-0 w-full" data-name="Purchase">
                      <div className="absolute h-[192px] left-0 top-0 w-[333.333px]" data-name="Image (RAYDA Mountain Pro)">
              ...
              <div className="content-stretch flex flex-col gap-[32px] items-start pt-[48px] px-[16px] relative size-full">
                ...
                <div className="h-[632px] relative shrink-0 w-full" data-name="Container">
                  <ContainerBackgroundImage additionalClassNames="top-0">
                    ...
                    <div className="absolute bg-gradient-to-r content-stretch flex from-[#155dfc] items-center justify-center left-[133.15px] px-[16.758px] rounded-[16px] size-[67.031px] to-[#1447e6] top-[22.48px]" data-name="Container">
                      <div className="relative shrink-0 size-[33.515px]" data-name="Icon">
                        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 33.5154 33.5153">
                          <g id="Icon">
                            <path d={svgPaths.p34455500} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.79294" />
                          </g>
                        </svg>
                      </div>
                    </div>
                  ...
                  <ContainerBackgroundImage additionalClassNames="top-[212px]">
                    ...
                    <div className="absolute bg-gradient-to-r content-stretch flex from-[#155dfc] items-center justify-center left-[134.67px] px-[16px] rounded-[16px] size-[64px] to-[#1447e6] top-[14.53px]" data-name="Container">
                      <IconBackgroundImage>
                  ...
                  <div className="absolute h-[208px] left-0 rounded-[16px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] top-[424px] w-[333.333px]" data-name="Container" style={{ backgroundImage: "linear-gradient(148.036deg, rgb(249, 250, 251) 0%, rgb(243, 244, 246) 100%)" }}>
                    ...
                    <div className="absolute flex items-center justify-center left-[133.81px] size-[65.713px] top-[23.14px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
                      <div className="flex-none rotate-[1.56deg]">
                        <div className="bg-gradient-to-r content-stretch flex from-[#155dfc] items-center justify-center px-[16.428px] relative rounded-[16px] size-[64px] to-[#1447e6]" data-name="Container">
                          <IconBackgroundImage>
          ...
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[32px] items-start pt-[32px] px-[16px] relative size-full">
            ...
            <div className="content-stretch flex flex-col h-[45.333px] items-start pt-[25.333px] relative shrink-0 w-full" data-name="Container">
              ...
              <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
                <p className="-translate-x-1/2 absolute font-['Montserrat:Regular',sans-serif] font-normal leading-[20px] left-[166.73px] text-[#99a1af] text-[14px] text-center top-[0.33px] whitespace-nowrap">© 2026-2027 RAYDA. Все права защищены</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="content-stretch flex h-[64px] items-center justify-between relative shrink-0 w-full" data-name="Container">
          <div className="h-[40px] relative shrink-0 w-[121.917px]" data-name="Link">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4.214px] items-center pl-[-3.786px] relative size-full">
              <BackgroundImage1 additionalClassNames="size-[47.571px]">
                <div className="flex-none rotate-[-167.76deg]">
                  <div className="bg-[#155dfc] relative rounded-[44739200px] size-[40px]" data-name="Container">
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[14.343px] relative size-full">
                      <BackgroundImage1 additionalClassNames="h-[30.544px] w-[20.595px]">
                        <div className="flex-none rotate-[167.76deg]">
